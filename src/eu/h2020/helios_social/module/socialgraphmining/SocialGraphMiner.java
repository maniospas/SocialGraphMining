...
public abstract class SocialGraphMiner {
     ...
     * This method should typically return values in the [0,1] range, where higher values correspond to more
     * likely interactions.
    ...
    /**
     * Calls the {@link #predictNewInteraction(Context, Node)} to score the likelihood of interacting with all nodes
